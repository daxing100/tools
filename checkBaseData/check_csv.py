...
def check_names(api_response, csv_file):
    ext_names = read_csv(csv_file)
    print(ext_names)
...
# CSV文件路径
csv_file_path = 'ok_data_level3.csv'
check_names(api_response, csv_file_path)
